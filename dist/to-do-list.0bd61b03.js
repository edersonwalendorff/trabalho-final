...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/to-do-list.js":[function(require,module,exports) {
console.log('Executando o to-do-list ...');
var botaoAdicionar = document.querySelector('.btn.btn-success');
...
function adicionaLinha() {
  ...
  */
  ...
  tarefas.appendChild(novaRow); // Captura referências para os elementos interativos da nova linha:

  var novoCheckbox = novaRow.querySelector('input[type="checkbox"]');
  var novoInputText = novaRow.querySelector('input[type="text"]');
  var novoButton = novaRow.querySelector('button');
  /**
   * Handler do checkbox.
   * 
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/to-do-list.js"], null)
//# sourceMappingURL=/to-do-list.0bd61b03.js.map